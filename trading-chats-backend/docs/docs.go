...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/model-api-configs/provider": {
            "get": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.SaveSystemRuntimeConfigRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "models.SaveSystemRuntimeConfigRequest": {
            "type": "object",
            "properties": {
                "param1": {
                    "type": "string"
